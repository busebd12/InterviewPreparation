...
/*
Solution: inspired by this post --> https://leetcode.com/problems/n-queens/discuss/2107948/C%2B%2B-or-Easy-Explanation-w-Backtracking
...
class Solution
{
    public:
        ...
        void dfs(vector<vector<string>> & result, vector<string> & board, int rows, int columns, int row)
        {
